...
const TeacherDashboard: React.FC = () => {
  ...
  const [userExists, setUserExists] = useState<boolean>(id !== undefined);
  // useEffect(() => {
  ...
  //   }
  // }, []); // Re-run effect whenever the 'id' parameter changes
    ...
    <div className="container-fluid flex-fill py-5 bg-white">
      ...
      <div className="row justify-content-center align-items-center h-100">
        <div className="col-md-10">
          <UserProfile userid={teacherid} role="teacher"></UserProfile>
          <div
